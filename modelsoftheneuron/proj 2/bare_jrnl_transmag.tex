...
\title{Effect of varied ablations on the \emph{C. Elegans} Neural Network}


% author names and affiliations
% transmag papers use the long conference author name format.

\author{\IEEEauthorblockN{Greg Kiar\IEEEauthorrefmark{1}}
